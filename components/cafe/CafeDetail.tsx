...
import { MapPin, Star, Navigation, PenLine, Wifi, Zap, Volume2 } from 'lucide-react';
  ...
  return (
    <div className="px-4 pt-1 pb-8">
      ...
      <div className="flex items-start gap-1.5 mb-4">
        ...
        <p className="text-xs text-zinc-500 leading-relaxed">{cafe.address}</p>
      </div>
      ...
      <div className="flex gap-2.5">
        <button className="flex-1 bg-zinc-900 active:bg-zinc-800 text-white rounded-2xl py-3 text-sm font-semibold flex items-center justify-center gap-1.5 transition-colors">
